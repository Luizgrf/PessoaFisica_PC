...
import control.PFJdbc;
import control.JdbUtil;
...
public class PessoaFisica extends JFrame{
	...
	public JTextField txtEnd = new JTextField();
	JLabel end = new JLabel("ENDEREÇO: ");
	
	public JTextField txtBairro = new JTextField();
	JLabel bairro = new JLabel("BAIRRO: ");
	
	public JFormattedTextField txtCep = null; //txt formatado
	JLabel cep = new JLabel("CEP: ");
	
	public JTextField txtCidade = new JTextField();
	JLabel cidade = new JLabel("CIDADE: ");	
	
	JLabel est = new JLabel("ESTADO: ");
	public JLabel lbl_est = new JLabel(" "); //Usada na impressão de dados sobre o estado
	public JComboBox cmbEst = new JComboBox(); //aparecer opcoes dos estados
	
	public JFormattedTextField txtTel = null;
	JLabel tel = new JLabel("TELEFONE: ");
	
	public JFormattedTextField txtCel = null;
	JLabel cel = new JLabel("CELULAR: ");
	
	public JFormattedTextField txtRg = null;
	JLabel rg = new JLabel("RG: ");
	
	public JFormattedTextField txtCpf = null;
	...
	public JRadioButton[] rdbsexo = new JRadioButton[2]; //botão para opçoes
	...
	public PessoaFisica(){
		...
		paine.add(lbl_est);
		lbl_est.setBounds(400,105,70,30);
		lbl_est.setVisible(false);
		paine.add(cmbEst);
		...
		btnSalvar.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				pessoaFisica.setEstado((String)(cmbEst.getSelectedItem()));
			...
			try {
				...
				PFJdbc pf = new PFJdbc(connection);
				pf.guardar(pessoaFisica);
			} catch (Exception e1) {
				e1.printStackTrace();
			}
			}
